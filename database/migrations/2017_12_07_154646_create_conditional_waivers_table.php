...
class CreateConditionalWaiversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('conditional_waivers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('conditional_waivers');
    }
}
