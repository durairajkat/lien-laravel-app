...
class CreateWaiverOfLiensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('waiver_of_liens', function (Blueprint $table) {
            ...
            $table->decimal('ClaimAmount',8,2)->nullable();
    ...
    {
        Schema::dropIfExists('waiver_of_liens');
    }
}
