...
class CreatePartialWaiverDatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('partial_waiver_dates', function (Blueprint $table) {
            ...
            $table->string('ProjectCounty')->nullable();
            $table->string('ProjectState')->nullable();
            $table->string('Owner')->nullable();
            $table->decimal('CheckAmount',8,2)->nullable();
            $table->string('WaiverCustomer')->nullable();
            $table->string('WaiverState')->nullable();
    ...
    {
        Schema::dropIfExists('partial_waiver_dates');
    }
}
