...
{{--    @section('content')--}}
    ...
    <div class="">
        <div class="row">
            ...
            @if (isset($_GET['view']) && $_GET['view'] === 'detailed')
                <form method="post" action="{{ route('save.owner.notice', ['view' => 'detailed']) }}"
                    class="form-horizontal create-project-form create-project-form--wide">
                @elseif(!isset($_GET['view']) && isset($_GET['create']) && $_GET['create'] === 'true')
                    <form method="post" action="{{ route('save.owner.notice', ['view' => 'express']) }}"
                        class="form-horizontal create-project-form create-project-form--wide">
                    @else
                        <form method="post" action="{{ route('save.owner.notice') }}"
                            class="form-horizontal create-project-form create-project-form--wide">
            @endif
                ...
                <div class="table-responsive">
                    <div class="row">
                        ...
                        <span class="gc_show" id="show_general_contractor"
                            style="display:{{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->is_gc == '0' ? 'inline' : 'none' }}">
                            <div class="col-md-6 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                ...
                                <div class="row"
                                    style="display: {{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2' ? 'block' : 'block' }};">
                                    <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 formTable"
                            style="display: {{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2' ? 'block' : 'block' }};">
                            <div class="job-info-panel-input-wrapper">
                                <label for="job_zip">County</label>
                                <input type="text" name="county" disabled value="{{ $project ? $project->county : '' }}">
                            </div>
                        ...
                        <div class="col-md-6 formTable contractInformation job-info-panel--label">
                            ...
                            <div class="col-sm-6 no-padding">
                                <input type="text" id="revisedTotal" name="revisedTotal"
                                    ...
                                    data-contract="{{ $contractCreated }}" disabled>
                            </div>
                            <div class="col-sm-6 no-padding">
                            ...
                            <div class="col-sm-6 no-padding">
                                <input type="text" id="job_no" name="job_no"
                                    value="{{ isset($contract->job_no) && !empty($contract->job_no) ? $contract->job_no : '0' }}"
                                    data-contract="{{ $contractCreated }}" disabled>
                            </div>
                            ...
                            <div class="col-sm-6 no-padding">
                                <textarea style="width:100%" type="text" id="general_description" name="general_description"
                                    value="" data-contract="{{ $contractCreated }}"
                                    disabled>{{ isset($contract->general_description) && !empty($contract->general_description) ? $contract->general_description : '' }}</textarea>
                            </div>
                        </div>
            ...
            @endif
            @if ($gc == 1)
                <div class="job-info-accordion gc_hide generalContractor1" data-target="general_contractor">
            ...
            @endif
            @if ($owner == 1)
                <div class="job-info-accordion gc_hide generalContractor1" data-target="owner">
                ...
                <div class="table-responsive">
                    <div class="black-box-main">
                        ...
                        <div class="row">
                            <div class="col-md-12 footerTxt">
                                <p>
                                    I understand that <strong>BUILDERS NOTICE CORP</strong> may not be able to ascertain to
                                    whom the Notice to Owner should
                                    be sent. Further, it is expressly understood that I hereby waive any claim again
                                    Builders Notice Corp. that I or my firm
                                    have or may have in the future due to the inability of Builders Notice Corp. to
                                    ascertain who should receive NOTICE to OWNER
                                    copies. I hereby agree on behalf of myself and my firm to pay for any research,
                                    preparation and serving expenses generated
                                    by my request or my representatives upon receipt of the invoice. In the event that
                                    payment is not made within 30 days of the
                                    ...
                                    provides or agrees to provide, it is agreed that the limit of liability of Builders
                                    Notice Corp., and/or its affiliates, officers,
                                    employees and assigns inclusive of any interest, costs, and attorney fees shall not
                                    exceed One Thousand Dollars ($1000). In the
                                    ...
                                    for increased liability at increased cost. I authorize Builders Notice Corp. personnel
                                    to sign on behalf of myself and /or
                                    ...
                                    other subscribers the jobs upon which we are working in connection with the Network
                                    Credit Service.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row footerTxt">
                            @if(isset($lienProvider) && !empty($lienProvider->logo))
                                <div style="text-align:center; "><img src="/liens/{{$lienProvider->logo}}" alt="NLB" align="middle"></div>
                            @endif
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 field mobile--agree">
                                <label><input type="checkbox" name="Agree" id="agree"
                                        ...
                                        {{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2' ? 'disabled1' : '' }}>
                                    &nbsp;By submitting this
                                    form, you agree to the Liability Limitation terms stated herein.
                                </label>
                            </div>
                        </div>
            ...
            <div class="form-group error-field" style="display: none; color: red;">
                <label for="error" class="col-sm-4 control-label">
                    Error
                </label>
                <div class="col-sm-8">
                    <span id="error"></span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input class="form-control error" type="text" name="county" id="county"
