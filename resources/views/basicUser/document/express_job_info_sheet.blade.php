...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="project-header">
            ...
            @endif
            <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 75%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">Step 3</div>
            </div>
        </div>
    @else
    @endif
    ...
    @if(isset($_GET['view']) && $_GET['view'] === 'detailed')
    <form method="post" action="{{ route('save.new.job', ['view' => 'detailed']) }}" class="form-horizontal create-project-form create-project-form--wide">
    @elseif(!isset($_GET['view']) && isset($_GET['create']) && $_GET['create'] === 'true')
    <form method="post" action="{{ route('save.new.job', ['view' => 'express']) }}" class="form-horizontal create-project-form create-project-form--wide">
    @else
    <form method="post" action="{{ route('save.new.job') }}" class="form-horizontal create-project-form create-project-form--wide">
    @endif
        <input type="hidden" value="{{ $project->id }}" name="project_id">
        {{ csrf_field() }}
        <div class="create-project-form-header">
            <h2>Express Job Information Sheet</h2>
            <div class="expand">
                <h4>Expand All</h4>
                <label class="switch">
                    <input type="checkbox">
        ...
        <div id="company_information" class="job-info-accordion job-info-accordion--top-margin" data-target="company_info">
        ...
        <div class="job-info-panel" id="company_info">
            ...
            <!--<div class="block-one">
                            ...
                            <div class="col-md-12 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input disabled
                                        ...
                                        name="company_name"
                                        id="company_name"
                                        value="{{ $user->details ? $user->details->getCompany ? $user->details->getCompany->company : '' : '' }}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    @foreach($states as $state)
                                        ...
                                        <input type="text"
                                            disabled
                                            value="{{ $user->details && $user->details->state_id == $state->id ? $state->name : '' }}">
                                        @endif
                                    @endforeach
                                </div>
                                <div class="job-info-panel-input-wrapper">
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="company_fname" disabled
                                           value="{{ $user->details ? $user->details->first_name : '' }}" class="autoCompleteSubUser" autocomplete="off">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                ...
                <div class="job-info-panel" id="your_customer">
                    <div class="table-responsive">
                        <div class="row">
                            <input type="hidden" id="hiddenCustomerId" name="customer_id" value="{{ $project->customer_contract ? $project->customer_contract->id : '' }}">
                            <span class="gc_show" id="show_general_contractor" style="display:{{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->is_gc == '0' ? 'inline' : 'none' }}{{--{{ isset($jobInfoSheet) && $jobInfoSheet != '' ? ($jobInfoSheet->is_gc == '0' ? 'inline' : 'none') : ($project->originalCustomer->name == 'Original Contractor' ? 'inline' : (!isset($jobInfoSheet) ? 'inline'  : 'none')) }};--}}">  / General Contractor </span>     {{--<small style="font-size: 8px;">( <em>*To add edit customer contact please click on Add/Edit contact button</em> )</small>--}}
                            <div class="col-md-6 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    <label for="customer_address">Address</label>
                                     <input type="text"
                                        ...
                                        value="{{ $project->customer_contract ? $project->customer_contract->contactsAd->address : '' }}">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $project->customer_contract ? $project->customer_contract->contactsAd->city : '' }}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="job_state">State</label>
                                    @if(!empty($project->customer_contract->company->state_id))
                                    @foreach($states as $state)
                                        @if($state->id === $project->customer_contract->company->state_id)
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ $project->customer_contract ? $project->customer_contract->contactsAd->zip : '' }}">
                                </div>
                                @php
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    value="{{ $project->customer_contract ? $project->customer_contract->contactsAd->fax : '' }}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="customer_web">Website</label>
                                    <input type="text" name="customer_web"
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    value="{{ $project->customer_contract != '' ? $project->customer_contract->contacts->first_name : ''}}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="customerLastName[]">Last Name</label>
                                    <input type="text" name="customerLastName[]"
                                    value="{{ $project->customer_contract != '' ? $project->customer_contract->contacts->last_name : ''}}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="customerTitle">Title</label>
                                    <input type="text" name="customerTitle"
                                    value="{{ $project->customer_contract != ''? ($project->customer_contract->contacts->title == 'Other' ? $project->customer_contract->contacts->title_other : $project->customer_contract->contacts->title) : '' }}">
                                </div>
                                @php
                    ...
                    <div class="table-responsive">
                        <div class="row">
                            <div class="col-md-6 formTable contractInformation job-info-panel--label">
                                ...
                                <div class="col-sm-6 no-padding">
                                    <input type="text" id="baseContract" name="baseContract" value="{{ number_format(isset($baseAmount) && !empty($baseAmount) ? $baseAmount : '0', 2)}}" data-contract="{{$contractCreated}}">
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <label for="extraCharges" class="label-light label-light--mobile">+ Value of Extras</label>
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <input type="text" id="extraCharges" name="extraCharges" value="{{ number_format(isset($extraCharges) && !empty($extraCharges) ? $extraCharges : '0', 2)}}" data-contract="{{$contractCreated}}">
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <label for="revisedTotal">Revised Contract Total</label>
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <input type="text" id="revisedTotal" name="revisedTotal" value="{{ number_format(isset($revised) && !empty($revised) ? $revised : '0', 2)}}" data-contract="{{$contractCreated}}" disabled>
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <label for="credits" class="label-light label-light--mobile">- Credits to Date</label>
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <input type="text" id="credits" name="credits" value="{{ number_format(isset($credits) && !empty($credits) ? $credits : '0', 2)}}" data-contract="{{$contractCreated}}">
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <label for="contract_amount">Total Claim Amount</label>
                                </div>
                                <div class="col-sm-6 no-padding">
                                    <input type="text" id="contract_amount" name="contract_amount" value="{{ number_format(isset($totalClaimAmount) && !empty($totalClaimAmount) ? $totalClaimAmount : '0', 2)}}" data-contract="{{$contractCreated}}" disabled>
                                </div>
                            </div>
                                ...
                                @foreach($projectDates as $date)
                                    <div class="row dateBreak">
                                        ...
                                        <div class="col-sm-4 dateContainer">
                                            @if(empty($date['dates']))
                                                @if($date['recurring'] === 1)
                                                    <input type="text" class="form-control date multiple" name="remedyDates[{{ $date['id'] }}]"
                                                    value=""
                                                    data-provide="datepicker" data-recurring="{{$date['recurring']}}" data-dateId = "{{ $date['id'] }}" data-existing="false">
                                                @else
                                                    <input type="text" class="form-control date multiple" name="remedyDates[{{ $date['id'] }}]"
                                                    value=""
                                                    data-provide="datepicker" data-recurring="{{$date['recurring']}}" data-dateId = "{{ $date['id'] }}" data-existing="false">
                                            ...
                                            @else
                                                @foreach($date['dates'] as $value)
                                                    @if($date['recurring'] === 1)
                                                        <input type="text" class="form-control date multiple" name="remedyDates[{{ $date['id'] }}]"
                                                        value="{{$value['value']}}"
                                                        data-provide="datepicker" data-recurring="{{$date['recurring']}}" data-dateId = "{{$value['id']}}" data-existing="true">
                                                    @else
                                                        <input type="text" class="form-control date multiple" name="remedyDates[{{ $date['id'] }}]"
                                                        value="{{$value['value']}}"
                                                        data-provide="datepicker" data-recurring="{{$date['recurring']}}" data-dateId = "{{$value['id']}}" data-existing="true">
                                                ...
                                                @if($date['recurring'] === 1)
                                                    ...
                                                    <input type="text" class="form-control date multiple" name="remedyDates[{{ $date['id'] }}]"
                                                    value=""
                                                    data-provide="datepicker" data-recurring="{{$date['recurring']}}" data-dateId = "1" data-existing="false">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 formTable">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="job_address" disabled value="{{ $project ? $project->address : '' }}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="job_city">Job City</label>
                                    <input type="text" name="job_city" disabled value="{{$project ? $project->city : '' }}">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="job_zip" disabled value="{{ $project ? $project->zip : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 formTable" style="display: {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'none' : 'block' }};">
                ...
                @endif
                @if($gc == 1)
                <div class="job-info-accordion gc_hide generalContractor" style="display: {{ $project->originalCustomer->name == 'Original Contractor' ? 'none' : 'block' }}" data-target="general_contractor">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" style="display:none;">
                                <input type="radio" name="is_gc" class="is_gc" value="0" id="is_gc"
                                        {{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->is_gc == '0' ? 'checked' : '' }} {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'disabled' : '' }}> Yes
                                <input type="radio" name="is_gc" class="is_gc" id="not_gc" value="1" {{ isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->is_gc == '1' ? 'checked' : (!isset($jobInfoSheet) ? 'checked' : '') }} {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'disabled' : '' }}> No
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="gc_company"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_address">Address</label>
                                    <input type="text" name="gc_address"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_city">City</label>
                                    <input type="text" name="gc_city"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="gc_zip"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_phone">Phone Number</label>
                                    <input type="text" name="gc_phone"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_fax">Fax Number</label>
                                    <input type="text" name="gc_fax"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_web">Website</label>
                                    <input type="text" name="gc_web"
                                                               value="" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 formTable">
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="gc_first_name"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_last_name">Last Name</label>
                                    <input type="text" name="gc_last_name"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_title">Title</label>
                                    <input type="text" name="gc_title"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_direct_phone">Phone Number</label>
                                    <input type="text" name="gc_direct_phone"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_cell">Cell Phone</label>
                                    <input type="text" name="gc_cell"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="gc_email">Email</label>
                                    <input type="text" name="gc_email"
                                                               value="" readonly>
                                </div>
                                <div class="row" style="display: {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'none' : 'block' }};">
                ...
                @endif
                @if($owner == 1)
                <div class="job-info-accordion gc_hide generalContractor" style="display: {{ $project->originalCustomer->name == 'Original Contractor' ? 'none' : 'block' }}" data-target="owner">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="owner_fax"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="owner_web">Website</label>
                                    <input type="text" name="owner_web"
                                                               value="" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 formTable">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="owner_direct_phone"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="owner_cell">Cell Phone</label>
                                    <input type="text" name="owner_cell"
                                                               value="" readonly>
                                </div>
                                <div class="job-info-panel-input-wrapper">
                ...
                @if(count($projectContacts) > 0)
                    @foreach($projectContacts as $key => $contact )
                    <div class="job-info-accordion {{$contact['type'] == 'General Contractor' ? 'generalContractor' : ''}}" data-target="{{ $contact['company_id'] }}">
                        ...
                        <div class="black-box-main">
                            ...
                            <div class="row">
                                <div class="col-md-12 field mobile--agree">
                                    <label><input type="checkbox" name="Agree" id="agree" {{ isset($jobInfoSheet) && $jobInfoSheet != '' ? 'checked' : '' }} {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'disabled' : '' }}>
                                        &nbsp;By submitting this
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-8">
                                        <input name="Signature"
                                            ...
                                            value="{{ isset($jobInfoSheet) && $jobInfoSheet != '' ? $jobInfoSheet->signature : '' }}" {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'disabled' : '' }}
                                            />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <input name="SignatureDate" type="text"
                                               class="date "
                                               required="true"
                                               value="{{  isset($jobInfoSheet) && $jobInfoSheet != '' && !is_null($jobInfoSheet->signature_date) ? date('m/d/Y',strtotime($jobInfoSheet->signature_date)) :  '' /*Carbon\Carbon::today()->format('Y-m-d')*/}}"
                                               style="border: 0.5px solid #726d6d; background:#fff;"
                            ...
                            <div class="row">
                                ...
                                <div class="block-two" style="display: {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'none' : 'block' }};">
                                    <div class="black-box-main">
                                        @if(!isset($_GET['edit']))
                                            @if(!isset($_GET['saved']))
                                            <button type="submit" class="btn btn-success btn-lg save mobile--button mobile--button--wide project-save-quit project-save-quit--terms" name="send" value="send">Send and Save</button>
                                            <button type="submit" class="btn btn-info btn-lg save mobile--button mobile--button--wide project-create-continue project-create-continue--terms" name="send" value="save">Save</button>

                                            @else
                                            <a href="{{ route('project.task.view', ['project_id'=>$project->id, 'view'=>'detailed', 'create'=>'true', 'hide'=>'true']) }}" class="btn btn-success btn-lg mobile--button mobile--button--wide project-save-quit project-save-quit--terms">View Tasks</a>
                                            <button type="submit" class="btn btn-success btn-lg save mobile--button mobile--button--wide project-save-quit project-save-quit--terms" name="send" value="send">Send and Save</button>
                                            <button type="submit" class="btn btn-info btn-lg save mobile--button mobile--button--wide project-create-continue project-create-continue--terms" name="send" value="save">Save</button>
                                        ...
                                        @else
                                            ...
                                            @else
                                            <a href="{{ route('project.task.view', ['project_id'=>$project->id, 'view'=>'detailed', 'edit'=>'true', 'hide'=>'true']) }}" class="btn btn-success btn-lg mobile--button mobile--button--wide project-save-quit project-save-quit--terms">View Tasks</a>
                                            <button type="submit" class="btn btn-success btn-lg save mobile--button mobile--button--wide project-save-quit project-save-quit--terms" name="send" value="send">Send and Save</button>
                                            <button type="submit" class="btn btn-info btn-lg save mobile--button mobile--button--wide project-create-continue project-create-continue--terms" name="send" value="save">Save</button>
                                            ...
                                            @foreach($jobInfoSheet->jobFiles as $file)
                                                <div class="col-md-6" id="id{{ $file->id }}">
                                                    <div class="fileRow">
                                                        ...
                                                        <div class="col-xs-4 fileBtn" style="display: {{ (isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2') ? 'none' : 'block' }};">
                                                            <button type="button" class="btn btn-danger removeBtn" data-id="{{ $file->id }}"><i class="fa fa-times"></i> </button>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('script')
    <script>
        ...
        $('.btn-view-jobsheet').on('click', function (event) {
            ...
            // 16 aug
            window.location.href = baseUrl + '/member/project/summary/view/'+project_id+'?edit=true' ;
