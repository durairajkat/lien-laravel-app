...
@section('content')
    ...
    <form action={{ route('member.document.save') }} method="post"
            ...
            <div class="col-sm-12">
                <div class="item">
                    <div class="form-group project_div" style="padding:20px;">
                        ...
                        <select required name="project_id" class="form-control project_select">
                        ...
                        <input id="project_name" name="project_name" class="project_name" hidden />
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.project_select', function() {
            var selectedProject = $(this).children("option:selected").text();
            $('.project_div').find('input[name="project_name"]').remove()
            $('.project_div').append('<input type="hidden" name="project_name" value="' +
                selectedProject + '">')
