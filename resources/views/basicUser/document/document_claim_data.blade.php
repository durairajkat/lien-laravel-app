...
<body>
                                ...
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td><span class="FieldLabel">City
                                                ...
                                                <input name="Zip" type="text" class="InputLine"
                                                    value="{{ $company_details->zip or '' }}" maxlength="32"
                                                    style="width:80px" />
                                            </span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><span class="FieldLabel">FAX:</span>
                                            <input name="Fax" type="text" class="InputLine" value="" maxlength="16"
                                                style="width:292px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><span class="FieldLabel">Email:</span>
                                            <input name="Email" type="text" class="InputLine" value="" maxlength="255"
                                                style="width:260px" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td height="54"><strong>&nbsp;TODAY'S DATE:</strong>&nbsp;
                                <input name="ClaimDate" id="ClaimDate" type="text" class="InputLine DateField"
                                    value="{{ Carbon\Carbon::today()->format('Y-m-d') }}" style="width:80px" />
                                    ...
                                    <tr>
                                        ...
                                        <td width="508"><strong>YOUR CONTRACT INFORMATION:</strong><br />
                                            ...
                                            <input id="ContractDate" name="ContractDate" readonly type="text"
                                                ...
                                                value="{{ Carbon\Carbon::today()->format('Y-m-d') }}" maxlength="10"
                                                style="width:80px" />
                                            <input type="button" name="button_DataSheetDate223" value="..."
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="87">$
                                                                    <input name="BaseAmount" type="text"
                                                                        class="InputLine" id="base_amount"
                                                                        value="{{ $contract_info->project_contract->base_amount or '' }}"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>$
                                                                    <input name="ExtraAmount" type="text"
                                                                        class="InputLine" id="extra_amount"
                                                                        value="{{ $contract_info->project_contract->extra_amount or '' }}"
                                                                        style="width:80px;font-size:14px;text-align:right;"
                                                                        maxlength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>$
                                                                    <input name="Subtotal" type="text" class="InputLine"
                                                                        id="contact_total" readonly="true"
                                                                        style="width:80px;font-size:14px;text-align:right;"
                                                                        maxlength="12" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>$
                                                                    <input name="Payments" type="text" class="InputLine"
                                                                        id="payment"
                                                                        value="{{ $contract_info->project_contract->credits or '' }}"
                                                                        style="width:80px;font-size:14px;text-align:right;"
                                                                        maxlength="12" />
                                                                </td>
                                                            </tr>
                                        ...
                                        <td>
                                            <p>Did you provide?&nbsp;
                                                ...
                                                <input type="radio" name="CustomManufacture" id="CustomManufacture1"
                                                    onClick="$('.NoPrint1').show(); $('#CustomManufactureDate').show();"
                                                    value="Yes" />
                                                ...
                                                <input id="CustomManufactureDate" name="CustomManufactureDate" readonly
                                                    type="text" class="InputLine DateField" value=""
                                                    style="width:80px" />
                                            ...
                                            class=" NoPrint1">
                                                <input type="radio" name="CustomManufacture" id="CustomManufacture0"
                                                    value="No"
                                                    onClick="$('.NoPrint1').hide(); $('#CustomManufactureDate').hide();" />
                                ...
                                <table width="100%" border="0">
                                    <tr>
                                        <td colspan="4">
                                            ...
                                            <p><label><input type="checkbox" name="Agree" id="agree" value="1">
                                                    &nbsp;By submitting this
                                    ...
                                    <tr>
                                        ...
                                        <td width="32%"><label>
                                                <input name="Signature" type="text" class="InputLine" value="" />
                                            </label></td>
    ...
    echo ' checked="checked"';
        ...
        <div align="center" style="padding-top: 20px">
            <div align="center"> Input the claim information that relates to your company and project. If you have any
