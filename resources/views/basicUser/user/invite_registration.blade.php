...
@section('title', 'Invitation Register')

@section('content')
    <div class="grey-section">
        <h3>Construction Lien Manager™ Invitation Membership Registration</h3>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="login">
                    <form class="form-signin" action="{{ route('member.invite.registration') }}" method="post">
