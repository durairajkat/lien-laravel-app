                                        ...
                                        <div class="border-table shadow left-box">
                                            ...
                                            <div class="checkbox-area">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="exampleCheck1">By checking this box
                                                        I agree to these terms</label>
                                                </div>
                  ...
                  <div class="border-table shadow left-box box-height2">
                     <div class="center-part">
                        ...
                        <div class="form-group">
                           <input class="form-control form-date" placeholder="First Day of Work" type="text" id="datepicker"> to <input class="form-control form-date" placeholder="Last Day of Work" type="text" id="datepicker1">
                        </div>
