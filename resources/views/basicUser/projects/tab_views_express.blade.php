<div class="time-nav">
    <div class="header-progress-container">
        <ol class="header-progress-list">
            ...
            @endif
            @if (\Request::get('view') != 'detailed')
                @if (\Request::route()->getName() == 'project.lien.view' || \Request::route()->getName() == 'project.deadline.view' || \Request::route()->getName() == 'project.document.view' || \Request::route()->getName() == 'project.task.view')
                    <li class="header-progress-item done"> <a
                            href="{{ $project_id ? route('project.lien.view') . '?project_id=' . $project_id : 'javascript:void(0)' }}">Slide
                            Chart For Lien Deadlines</a></li>
                @else
