...
<div class="container">
    <div class="row">
                                        ...
                                        <div class="">
                                            <div class="col-md-4 col-md-offset-4">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#express">Express</a>
                                                    </li>
                                            ...
                                            <div id="express" class="tab-pane fade in active">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="main-tab-sec">
                                                            <div class="main-tab-menu">
                                                                <ul class="nav nav-tabs">
                                                                    ...
                                                                    <li class="active">
                                                                        <a data-toggle="tab" href="#lienLawChart">Lien
                                                                            Slide Chart</a>
                                                                    </li>
                                                                    <li>
                                                                        <a data-toggle="tab" href="#documentsLienLaw">Documents</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="tab-content tab-final">
                                                        ...
                                                        <div id="lienLawChart" class="tab-pane fade in active">
                                                            <div class="box">
                                                                <div class="head-top">
                                                                    {{ $project->state->name }}
                                                                    ...
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading">
                                                                            <h4 class="panel-title">
                                                                                <a data-toggle="collapse" data-parent="#accordion" href="#{{ $remedyKey }}">{{ $name }}</a>
                                                                            </h4>
                                                                        </div>
                                                                        @if(count($liens) > 0)
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="col-md-5">
                                                                                            <div align="right">
                                                                                                ...
                                                                                                <p>
                                                                                                    <a href="javascript:void(0)" class="show_more" id="customerMore{{ $project->customer_contract->id }}" data-id="{{ $project->customer_contract->id }}">Show
                                                                                                        More</a>
                                                                                                    <a href="javascript:void(0)" class="show_less" id="customerLess{{ $project->customer_contract->id }}" data-id="{{ $project->customer_contract->id }}">Show
                                                                                                        Less</a>
                                                                                                </p>
                                                                                                @endif
                                                                                                @else
                                                                                                <div class="customer{{ $project->customer_contract->id }}" style="display: none;">
                                                                                                    <p>
                                                                                                        First
                                                                                                        :
                                                                                                        <strong>{{ $contactInformation->first_name != '' ? $contactInformation->first_name : 'N/A'}}</strong>,
                                                                ...
                                                                <div id="industry{{ $contact->contacts->id }}" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        <div class="panel-main">
                                                                            <div class="col-md-12">
                                                                                <div class="col-md-5">
                                                                                ...
                                                                                <div class="col-md-5">
                                                                                    <div align="right">
                                                                                        ...
                                                                                        <p>
                                                                                            <a href="javascript:void(0)" class="show_more" id="customerMore{{ $contact->contacts->id }}" data-id="{{ $contact->contacts->id }}">Show
                                                                                                More</a>
                                                                                            <a href="javascript:void(0)" class="show_less" id="customerLess{{ $contact->contacts->id }}" data-id="{{ $contact->contacts->id }}">Show
                                                                                                Less</a>
                                                                                        </p>
                                                                                        @endif
                                                                                        @else
                                                                                        <div class="customer{{ $contact->contacts->id }}" style="display: none;">
                                                                                            <p>
                                                                                                First
                                                                                                :
                                                                                                <strong>{{ $contactInformationIns->first_name != '' ? $contactInformationIns->first_name : 'N/A'}}</strong>,
                                                            ...
                                                            <div class="head-top">
                                                                &nbsp;
                                                                <div cl@include('basicUser.projects.include.project_view_lien_slide_chart')ass="pull-right">
                                                ...
                                                <div id="documentsLienLaw" class="tab-pane fade">
                                                    <div class="border-table">
                                                        <!-- <h1 class="text-center">Project Documents</h1>
                                                                            <hr class="divider"> -->
                                                        <form action="#" method="post" class="form-horizontal project-form project_documents_lien">
                                                            <div class="form-group">
                                                                <label class="col-md-2">Create
                                                                    Documents</label>
                                                                <div class="col-md-6">
                                                                    <select id="DocumentTypeLien" class="form-control" name="DocumentType">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <button class="blue-btn" id="createDocumentLien" type="button" disabled>
                                                                        Create
                                                                        document
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button id="lianLawSummery" type="button" class="form-control btn blue-btn btn-success">
                                                                                    View
                                                                                </button>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="{{ route('get.documentClaimView',[$project_id,$flag]) }}" class="form-control btn blue-btn btn-success">View</a>
                                                                            </td>
                                                                            @elseif($document['name'] == 'Credit Application')
                                                                            <td>
                                                                                <a href="{{ route('get.documentCreditView',[$project_id,$flag]) }}" class="form-control btn blue-btn btn-success">View</a>
                                                                            </td>
                                                                            @elseif($document['name'] == 'joint payment authorization')
                                                                            <td>
                                                                                <a href="{{ route('get.documentJointView',[$project_id,$flag]) }}" class="form-control btn blue-btn btn-success">View</a>
                                                                            </td>
                                                                            @elseif($document['name'] == 'Waver progress')
                                                                            <td>
                                                                                <a href="{{ route('get.documentWaverView',[$project_id,$flag]) }}" class="form-control btn blue-btn btn-success">View</a>
                                                                            </td>
                                                                            @elseif($document['name'] == 'job info sheet')
                                                                            <td>
                                                                                <div class="col-md-12">
                                                                                    <div class="col-md-6">
                                                                                        <a href="{{ route('get.jobInfoView',[$project_id]) }}" class="form-control btn blue-btn btn-success viewBtn" target="_blank">View</a>
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <a href="{{ route('get.jobInfoExport',[$project_id]) }}" class="form-control btn btn-info" target="_blank">Export
                                                                                            as
                                                                                            PDF</a>
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="main-tab-sec">
                                            ...
                                            <div class="tab-content tab-final">
                                                ...
                                                <div id="lienLawChartDetailed" class="tab-pane fade in active">
                                                    <div class="box">
                                                        <div class="head-top">
                                                            {{ $project->state->name }}
                                                            <div class="pull-right">
                                                        ...
                                                        <div class="panel-group" id="accordion_detailed">
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse" data-parent="#accordion_detailed" href="#detailed_{{ $remedyKey }}">{{ $name }}</a>
                                                                    </h4>
                                                                </div>
                                                                @if(count($liens) > 0)
                                                                @foreach($liens as $key => $lien)
                                                                @if( $name == $lien['remedy'] )
                                                                <div id="detailed_{{ $key }}" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        <div class="panel-main">
                                                                            <p style="font-size: medium;">
                                                                                <strong>Description:</strong> {{ $lien->description }}
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse" data-parent="#accordion_detailed" href="#jobDescription_detailed">Job
                                                                            Description (
                                                                            <small><strong>{{ $project->project_name }}</strong></small>
                                                                            )</a>
                                                                    </h4>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse" data-parent="#accordion_detailed" href="#customer_detailed">Customer
                                                                            -
                                                                            <small><strong>{{ !is_null($project->customer_contract->company) && !is_null($project->customer_contract->company->company) ?$project->customer_contract->company->company : 'N/A' }}</strong></small>
                                                                        </a>
                                                                    </h4>
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $deadline->short_description }}
                                                                    <span class="tag label label-info">{{ $deadlines[$key]->getRemedy->remedy }}</span>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control date" name="date-legal[]" disabled="disabled" data-provide="datepicker" value="{{ $deadlines[$key]['legal_completion_date'] }}">
                                                                </td>
                                                                <td>
                                                ...
                                                <div id="{{ $remedyKey }}" class="tab-pane fade">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control date" disabled="disabled" name="date-legal[]" data-provide="datepicker" value="{{ $deadlines[$key]['legal_completion_date'] }}">
                                                            </td>
                                                            <td>
                                                                <select name="email-alert[]" disabled="disabled">
                                                                    <option value="1" {{ $deadlines[$key]['email_alert'] == 1 ? 'selected' : ''}}>
                                                            ...
                                                            <table class="table">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th><input type="number" class="form-control" name="base_amount" id="base_amount" value="{{ (isset($contract) && $contract != '' && $contract->base_amount != '')?$contract->base_amount:'0' }}" disabled>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <th><input type="number" class="form-control" name="extra_amount" id="extra_amount" value="{{ (isset($contract) && $contract != '' && $contract->extra_amount != '')?$contract->extra_amount:'0' }}" disabled>
                                                                        </th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>= Revised Contract
                                                                        ...
                                                                        <th><input type="text" class="form-control" id="contact_total" disabled="disabled" disabled>
                                                                        </th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>- Payments/Credits
                                                                        ...
                                                                        <th><input type="number" class="form-control" name="payment" id="payment" value="{{ (isset($contract) && $contract != '' && $contract->credits != '')?$contract->credits:'0' }}" disabled>
                                                                        </th>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <th><input type="text" class="form-control" id="claim_amount" name="claim_amount" disabled="disabled" disabled>
                                                                        </th>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="table-responsive waiver-table">
                                                            <table class="table">
                                                                <thead>
                                                                    <tr>
                                                                        <td>Waiver Amount</td>
                                                                        <th><input type="number" name="waiver_amount" value="{{ (isset($contract) && $contract != '' && $contract->waiver != '')?$contract->waiver:'0' }}" disabled class="form-control">
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                            ...
                                            <div class="border-table">
                                                ...
                                                <form action="#" method="post" class="form-horizontal project-form project_dates">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control date" name="remedyDates[{{ $date->id }}]" value="{{ isset($projectDates[$date->id])?$projectDates[$date->id]:'' }}" data-provide="datepicker" disabled>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                    {{ csrf_field() }}
     ...
     @if(count($tasks) > 0) -->
                                                            ...
                                                            <table class="table table-striped">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button class="btn btn-xs btn-warning editButton" type="button" data-id="{{ $task->id }}" data-action="{{ $task->task_name }}" data-due_date="{{ \DateTime::createFromFormat('Y-m-d', $task->due_date)->format('d/m/Y') }}" data-complete_date="{{ $task->complete_date != ''?\DateTime::createFromFormat('Y-m-d', $task->complete_date)->format('d/m/Y'):'' }}" data-email="{{ $task->email_alert }}" data-comment="{{ $task->comment }}" data-toggle="modal">
                                                                                <i class="fa fa-pencil"></i>
                                                                            </button>
                                                                            <button class="btn btn-xs btn-danger deleteTask" data-id="{{ $task->id }}" type="button">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form action="{{ route('project.add.task') }}" class="form-horizontal border-class" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="control-label col-md-2">Due
                                                                    Date</label>
                                                                <div class="col-md-2">
                                                                    <input type="text" class="form-control date" name="due_date" data-provide="datepicker">
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <button type="submit" class="btn btn-lg blue-btn col-md-2">
                                                                    Add
                                                                    Task
                                                                </button>
                                                            </div>
                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control date" id="due_date" data-provide="datepicker">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4">Complete-Date</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control date" id="complete_date" data-provide="datepicker">
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $('#lianLawSummery').on('click', function() {
            url = "{{ route('get.lineBoundSummery',[$project->state_id,$project->project_type_id]) }}";
        ...
        $('#createDocument').on('click', function() {
            ...
            if (document == 'ClaimData') {
                url = '{{ route('
                get.documentClaimData ',[$project_id]) }}';
            } else if (document == 'CreditApplication') {
                url = '{{ route('
                get.creditApplication ',[$project_id]) }}';
            } else if (document == 'JointPaymentAuthorization') {
                url = '{{ route('
                get.jointPaymentAuthorization ',[$project_id]) }}';
            } else if (document == 'UnconditionalWaiverProgress') {
                url = '{{ route('
                get.documentUnconditionalWaiverRelease ',[$project_id]) }}';
            } else if (document == 'ConditionalWaiver') {
                url = '{{ route('
                get.documentConditionalWaiver ',[$project_id]) }}';
            } else if (document == 'ConditionalWaiverFinal') {
                url = '{{ route('
                get.documentConditionalWaiverFinal ',[$project_id]) }}';
            } else if (document == 'UnconditionalWaiverFinal') {
                url = '{{ route('
                get.documentUnconditionalWaiverFinal ',[$project_id]) }}';
            } else if (document == 'PartialWaiver') {
                url = '{{ route('
                get.documentPartialWaiver ',[$project_id]) }}';
            } else if (document == 'PartialWaiverDate') {
                url = '{{ route('
                get.documentPartialWaiverDate ',[$project_id]) }}';
            } else if (document == 'WaiverOfLien') {
                url = '{{ route('
                get.documentStandardWaiverFinal ',[$project_id]) }}';
            } else if (document == 'JobInfo') {
                url = '{{ route('
                get.job.info.sheet ',[ $project_id ]) }}';
            } else {
                url = '{{ route('
                member.dashboard ') }}';
            }
