                                    ...
                                    <div class="col-md-10 col-sm-10  col-sm-offset-1">
                                        <div class="profile-box">
                                            ...
                                            <div class="table-responsive">
                                                <form action="{{ route('lien.action.profile') }}" method="post" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="pad15 company">
                                                                                <input type="text" name="companyName" readonly
                                                                                       ...
                                                                                       id="userCompany"
                                                                                       class="form-control">
                                                                                {{--<select name="companyName" id="userCompany" class="form-control chosen">
                                                                                    <option value=""></option>
                                                                                    @isset($companies)
                                                                                        @foreach($companies as $key => $company)
                                                                                            <option value="{{$key}}" @if(!is_null($user->lienUser) && $user->lienUser->company_id == $key){{'selected'}}@endif>{{$company}}</option>
                                                                                        @endforeach
                                                                                    @endisset
                                                                                </select>--}}
                                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            <div class="pad15 name">
                                                                                <div class="row">
                                                                                    <input type="text"
                                                                                           name="firstName"
                                                                                           value="{{ !is_null($user->lienUser) && isset($user->lienUser->firstName)? $user->lienUser->firstName : ''}}"
                                                                                           id="userFirstName"
                                                                                           class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            <div class="pad15 name">
                                                                                <input type="text"
                                                                                       name="lastName"
                                                                                       value="{{ !is_null($user->lienUser) && isset($user->lienUser->lastName)? $user->lienUser->lastName : ''}}"
                                                                                       id="userLastName"
                                                                                       class="form-control">
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="pad15 phone">
                                                                                <input type="text" name="phone"
                                                                                       value="{{ !is_null($user->lienUser) && isset($user->lienUser->phone)? $user->lienUser->phone : ''}}"
                                                                                       id="phone"
                                                                                       class="form-control">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="pad15 office_phone">
                                                                                ...
                                                                                <input type="text"
                                                                                       name="office_phone"
                                                                                       value="{{ !is_null($user->lienUser) && !is_null($user->lienUser->companyPhone) ? $user->lienUser->companyPhone : ''}}"
                                                                                       id="office_phone"
                                                                                       class="form-control">
                                                                        ...
                                                                        <td colspan="2">
                                                                            <div class="pad15 address">
                                                                                <textarea name="address"
                                                                                          id="userAddress"
                                                                                          class="form-control">{{ !is_null($user->lienUser) && !is_null($user->lienUser->address) ? $user->lienUser->address : ''}}</textarea>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="pad15 website">
                                                                                <input type="url" name="website"
                                                                                       value="{{ !is_null($user->lienUser) && !is_null($user->lienUser->getCompany) && isset($user->lienUser->getCompany->website)? $user->lienUser->getCompany->website : ''}}"
                                                                                       id="userWebsite"
                                                                                       class="form-control">
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="pad15 city">
                                                                                <input type="text" name="city"
                                                                                       value="{{ !is_null($user->lienUser) && !is_null($user->lienUser->city) ? $user->lienUser->city : ''}}"
                                                                                       id="userCity"
                                                                                       class="form-control">
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="pad15 zip">
                                                                                <input type="text" name="zip"
                                                                                       value="{{ !is_null($user->lienUser) && !is_null($user->lienUser->zip) ? $user->lienUser->zip : ''}}"
                                                                                       id="userZip"
                                                                                       class="form-control">
                                                                            </div>
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td colspan="3">
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" name="company_name" id="company_name" value="{{ !is_null($user->lienUser) && !is_null($user->lienUser->getCompany) ?  $user->lienUser->getCompany->company : '' }}">
                                                                    {{--<div class="align-center col-md-4 col-sm-4 col-xs-4">
                                                                        <button type="button" class="blue-btn trigger-modal addSubUser" data-type="add"
                                                                        >Create subusers</button>
                                                                    </div>--}}
                                                    ...
                                                    <table class="table profile-table">
                                                        ...
                                                        @if(isset($subusers))
                                                            @forelse($subusers as $subuser)
                                                                <tr>
                                                                    <td><div class="pad15">{{isset($subuser->mapcompanyContacts) && isset($subuser->mapcompanyContacts->company) ? $subuser->mapcompanyContacts->company->company : 'N/A'}}</div></td>
                                                                    <td><div class="pad15">N/A</div></td>
                                                                    <td><div class="pad15">{{isset($subuser->details) ? $subuser->details->first_name : 'N/A' }}</div></td>
                                                                    <td><div class="pad15">{{isset($subuser->details) ? $subuser->details->last_name : 'N/A' }}</div></td>
                                                                    <td><div class="pad15">{{$subuser->email}}</div></td>
                                                                    <td><div class="pad15">{{isset($subuser->details) ? $subuser->details->phone : 'N/A' }}</div></td>
                                                                    <td><div class="pad15">{{isset($subuser->details) && !is_null($subuser->details->office_phone) ? $subuser->details->office_phone : 'N/A' }}</div></td>
                        ...
                        .change(
                                function () {
                                    if($(this).val() != "new_data") {
                                        $.ajax({
                                            url: '{{route("lien.company.autocomplete")}}',
                                            dataType: "json",
                                            data: {
                                                key: $(this).val(),
                                                _token: '{{csrf_token()}}'
        ...
        $(document).ready(function () {
            ...
            $('.change-password').on('click', function () {
                ...
                if (flag) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('lien.change.password') }}",
                        data: {
