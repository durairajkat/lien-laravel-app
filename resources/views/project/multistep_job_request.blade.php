        ...
        <section class="content">
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form role="form" class="registration-form" action="{{ route('job.request.action') }}"
                                method="POST">
                                <fieldset>
                                    <div class="form-top">
                                        <div class="form-top-left">
                                            <h3><span><i class="fa fa-calendar-check-o" aria-hidden="true"></i></span>Select
                                    ...
                                    <div class="form-bottom">
                                        <div class="col-md-12" style="padding-top: 14px;">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" name="deadline_name[]"
                                                            id="deadline_name" placeholder="Name">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-1">
                                                        <input type="text" class="form-control" id="deadline_days" value="0"
                                                            name="deadline_years[]" placeholder="Years">
                                                    </div>
                                                    ...
                                                    <div class="col-md-1">
                                                        <button class="btn btn-success" id="addDeadline" type="button">
