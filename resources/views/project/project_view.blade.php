                            ...
                            <table class="table table-hover">
                                    ...
                                    <th>
                                        ...
                                        <a>
                                            <i class="fa fa-sort" aria-hidden="true" data-col="project_name"
                                               data-type="{{ isset($_GET['sortWith']) && $_GET['sortWith'] == 'user' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC' }}"></i>
                                        </a>
                                    </th>
                                    <th>
                                        Project Name
                                ...
                                @if (count($projects) > 0)
                                    @foreach ($projects as $key => $project)
                                        ...
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{  !is_null($project->name) ? $project->name: '' }}</td>
                                            <td>{{ $project->project_name }}</td>
                                            <td>{{ isset($company) ? $company : 'N/A' }}</td>
                                            <td>{{ !is_null($project->customer_contract) && !is_null($project->customer_contract->getContacts) ? $project->customer_contract->getContacts->first_name . ' ' . $project->customer_contract->getContacts->last_name : 'N/A' }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning btn-xs lock" data-id="{{ $project->id }}"
                                                    data-status="{{ $project->status }}" type="button"><i
                                                        class="fa fa-{{ $project->status == '1' ? 'unlock' : 'lock' }}"></i></button>
                                                <button class="btn btn-danger btn-xs delete-btn" type="button"
                                                    data-id="{{ $project->id }}" title="Delete"><i
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        @include('project.project_list_filter_admin')
                    </div>
                    <!-- /.box -->
                </div>
            </div>
