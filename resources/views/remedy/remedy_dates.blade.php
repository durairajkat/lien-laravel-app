                        ...
                        <div class="main-tab-sec">
                            ...
                            <div class="tab-content tab-final">
                                <div id="public" class="tab-pane fade in active">
                                    <form method="post" action="{{ route('remedy.hide.remedy_dates') }}">
                                        {{ csrf_field() }}
                                       ...
                                       <a href="{{ route('remedy.get.remedy_dates') }}" class="btn btn-danger">Reset</a>
                                                    ...
                                                    @foreach ($remedyDates as $key => $remedyDate)
                                                        <tr>
                                                            <td><input type="checkbox" name="hideRemedyDates[]"
                                                                    value="{{ $remedyDate->id }}" class="remdate"></td>
                                                            <td>{{ $key + 1 }}</td>
                                                            {{-- <td>{{ $remedyDate->remedy->state->name .' / '.$remedyDate->remedy->type->project_type .' / '.$remedyDate->remedy->remedy }}</td> --}}
                                                            @if(isset($remedyDate->getRemedy))
                                                                <td>{{ $remedyDate->getRemedy->state->name or 'NULL' }}/{{ $remedyDate->getRemedy->type->project_type or 'NULL' }}/{{ $remedyDate->getRemedy->remedy or 'NULL' }}</td>
                                                            @else
                                                                <td></td>
                                                            @endif
                                        ...
                                        <div>
                                            ...
                                            <div class="box-footer clearfix">
                                                <ul class="pagination pagination-sm no-margin pull-right">
                                                    {{ $remedyDates->appends(request()->query())->links() }}
                                                </ul>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div id="private" class="tab-pane fade">
                                       ...
                                       <a href="{{ route('remedy.get.remedy_dates') }}" class="btn btn-danger">Reset</a>
                                            ...
                                            <div class="box-body table-responsive no-padding">
                                                <table class="table table-striped">
                                                    ...
                                                    @if (count($remedyDatesPrivate) > 0)
                                                        @foreach ($remedyDatesPrivate as $key => $remedyDate)
                                                            <tr>
                                                                <td><input type="checkbox" name="hideRemedyDates[]"
                                                                        value="{{ $remedyDate->id }}"
                                    ...
                                    <button class="btn btn-danger btn-xs delete" type="button" data-id="{{ $remedyDate->id }}" title="Delete Remedy"><i class="fa fa-trash"></i> </button>
                                            ...
                                            <div>
                                                ...
                                                <div class="box-footer clearfix">
                                                    <ul class="pagination pagination-sm no-margin pull-right">
                                                        {{ $remedyDatesPrivate->appends(request()->query())->links() }}
                                                    </ul>
                                                </div>
                                            </div>
                                    </form>
