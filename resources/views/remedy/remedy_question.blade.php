                    ...
                    <div class="box">
                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" id="remedy_search"
                                        value="{{ isset($_GET['remedyQuestion']) && $_GET['remedyQuestion'] != '' ? $_GET['remedyQuestion'] : '' }}"
                            ...
                            <table class="table table-striped">
                                ...
                                @if (count($remedyQuestions) > 0)
                                    @foreach ($remedyQuestions as $key => $remedyQuestion)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $remedyQuestion->state->name }}</td>
                                            <td>{{ $remedyQuestion->type->project_type }}</td>
                                            <td>{{ $remedyQuestion->tier->tier_code }}</td>
                                            <td>{{ $remedyQuestion->question_order }}</td>
                                            <td>{{ $remedyQuestion->question }}</td>
                                            <td>
                                                {{ $remedyQuestion->answer }}
                                            </td>
                                            {{-- <td>
                                                 <button class="btn btn-info btn-xs addRemedy"
                                                         data-type="edit"
                                                         type="button" title="Edit"><i class="fa fa-pencil"></i> </button>
                                                 <button class="btn btn-danger btn-xs delete" type="button" data-id="{{ $remedyQuestion->id }}" title="Delete"><i class="fa fa-trash"></i> </button>
                                             </td> --}}
                                        </tr>
                                    @endforeach
                                @else
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                {{ $remedyQuestions->appends(Request::except('page'))->links() }}
                            </ul>
                        </div>
                    </div>
                </div>
