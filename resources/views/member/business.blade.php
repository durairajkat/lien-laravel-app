...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <button class="btn btn-md btn-success business" data-type="Add" type="button" data-toggle="modal">Add
                    new Business User
                </button>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">List of all business users</h3>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                @if (count($users) > 0)
                                    @foreach ($users as $key => $user)
                                        <tr>
                                            ...
                                            <td>{{ $user->email }}</td>
                                            <td>
                                                <button class="btn btn-info btn-xs business" data-type="Edit" type="button"
                                ...
                                @else
                                    <tr>
                                        <td colspan="5">No business users available.For add business click <a
                                                href="javascript:void(0)" data-type="Add" class="business"
                                                data-toggle="modal">here</a></td>
                                    </tr>
                                @endif
                            </table>
                        </div>
...
@section('modal')
    <!-- Modal -->
    <div id="addBusinessModel" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><span class="modalName"></span> Business user</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" class="btn btn-info pull-right" id="addBusinessButton"><i
    ...
    <script>
        $(document).ready(function() {
            $('.business').on('click', function() {
                ...
                $('.modalName').text(type);
                $('#addBusinessButton').attr('data-type', type);
                $('#addBusinessModel').modal('show');
            });
            $('#addBusinessButton').on('click', function() {
                var type = $(this).data('type');
